...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Findlet User - Claim Approval</title>
    <link
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($item['status'] === 'Approved'): ?>
                      <a href="preview-claim-approved.php?id=<?= $item['id'] ?>" class="action-link">View Claim</a>
                    <?php else: ?>
                      <a href="preview-claim.php?id=<?= $item['id'] ?>" class="action-link">View Claim</a>
                    <?php endif; ?>
                  </td>
                  <?php endforeach; ?>
                <?php endif; ?>
