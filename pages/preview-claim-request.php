...
// Set manual ID klaim & user
$id = 1;  // Ganti sesuai data di database kamu
$id_user = 1;

$query = "SELECT * FROM wallet_claims WHERE id = $id AND id_user = $id_user";
...
<div class="popup-overlay" onclick="closePopup(event)">
  <div class="popup-box" onclick="event.stopPropagation()">
    ...
    <div class="data">
      <div><b>Status:</b> <?= htmlspecialchars($claim['status']) ?></div>
...
<script>
  function closePopup(e) {
    window.location.href = 'claim-request.php'; // Ganti sesuai halaman asal
  }
</script>
