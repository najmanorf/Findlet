...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Report the Missing Wallet</title>
    <link
  ...
  <body>
    <div class="container">
      <div class="form-wrapper">
        <h2 class="form-title">
          Findlet<br /><small>Report the missing wallet</small>
        </h2>
        ...
        >
          ...
          <!-- Upload Wallet Photo -->
          <div class="mb-3">
            <label class="form-label">Upload Wallet Photo</label>
            <input
              type="file"
              class="form-control"
              name="wallet_image"
          ...
          <div class="mb-3">
            <label class="form-label">Upload ID Card Photo</label>
            <input
              type="file"
              class="form-control"
              name="card_image"
...
<?php
  ...
  if (isset($_POST['submit'])) {
      if (saveWalletReport($_POST, $_FILES)) {
          echo "<script>
                  alert('Data berhasil disimpan!');
                  window.location.href = '../pages/approval-report.php';
                </script>";
      } else {
          echo "<script>
