...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Findlet Admin - Report Approval</title>
    <link
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-2 sidebar">
          ...
          <a href="approval-report.php" class="nav-link active">📄 Report Approval</a>
        ...
        <div class="col-md-10 px-0">
          ...
          <div
            ...
            <a href="export-report.php" class="btn btn-success btn-export">⬇ Export CSV</a>
          </div>
            ...
            <table class="table table-borderless align-middle">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="#" class="btn btn-sm btn-outline-success btn-action">✏️</a>
                    <a href="delete-report.php?id=<?= $item['id'] ?>" 
